...
interface UseGetCurrentUserPlaylistOptions extends GetCurrentUserPlaylistRequest {
    enabled?: boolean;
}

const useGetCurrentUserPlaylist = ({ limit, offset, enabled = true }: UseGetCurrentUserPlaylistOptions) => {
